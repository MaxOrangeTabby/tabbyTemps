...
function WeatherCardAdd({data, addData} : WeatherCardAddProps) {
  return (
    <Center w={['90vw', '90vw', '60vw', '45vw', '30vw']} position={'absolute'} left={'50%'} transform={'translate(-50%, -50%)'} border={'1px solid #386150'}>
        <Card w={'100%'} fontFamily={'Raleway'}>
            ...
            <CardBody>
                <Flex direction={'row'} justify={'space-between'} align={'start'} gap={'1.15rem'}>
                    <Flex direction={'column'} justify={'space-between'} fontSize={['.75rem', 'sm', 'md', 'lg']} gap={'1rem'}>
                    ...
                    <Flex direction={'column'} fontSize={['.75rem', 'sm', 'md', 'lg']} gap={'1rem'}>
